...
from PRISHA_MUSIC.utils import AdminRightsCheck
from PRISHA_MUSIC.utils.database import is_active_chat, is_nonadmin_chat
from PRISHA_MUSIC.utils.decorators.language import languageCB
from PRISHA_MUSIC.utils.inline import close_markup, speed_markup
...
async def del_back_playlist(client, CallbackQuery, _):
    ...
    try:
        await PRISHA_MUSIC.speedup_stream(
            chat_id,
            file_path,
            speed,
            playing,

...
API_ID = int(getenv("29899250"))
API_HASH = getenv("611d045796c79af3e5ddfa3d6fd536a7")

# Get your token from @BotFather on Telegram.
BOT_TOKEN = getenv("8091671831:AAEpLXIfkInBGATHdGdBRlKuKjTOjmpIACg")
# -------------------------------------------------------
OWNER_USERNAME = getenv("@leavingproperty","leavingproperty")
# --------------------------------------------------------
BOT_USERNAME = getenv("@PRISHAMUSIC_bot","PRISHAMUSIC_bot")
# --------------------------------------------------------
BOT_NAME = getenv("PRISHA MUSIC")
# ---------------------------------------------------------
...
LOGGER_ID = int(getenv("LOGGER_ID", -1003210469133))

# Get this value from @PURVI_HELP_BOT on Telegram by /id
OWNER_ID = int(getenv("OWNER_ID", 7549194607))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/PRISHA_MUSICmusic777/PRISHA_MUSIC",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/iamPRISHA_MUSIC77")
